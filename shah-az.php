...
<body >
    ...
    <div class="portfolio-bg-shah">
        <div class="portfolio-header">
            <img src="\images\what_we_done\shah-logo.png" class="portfolio-logo">
            <p class="text-center">
                Website for Shah Restaurant
            </p>
        </div>
    ...
    <div class="container">
        <div class="row-centered">
            ...
            <div class="clearfix portfolio-content-images">
                <img src="\images\what_we_done\screen_top.png" class="img-responsive screen-top" />
                <img src="\images\what_we_done\shah-1.jpg" class="img-responsive" alt="Chat platform for Brav. Develolper" style="margin: 0; padding: 0"/>
                <img src="\images\what_we_done\screen_bot.png" class="img-responsive screen-bot"/>

                <div class="top-buffer"></div>
                <img src="\images\what_we_done\screen_top.png" class="img-responsive screen-top" />
                <img src="\images\what_we_done\shah-2.jpg" class="img-responsive" alt="Chat platform for Brav. Develolper" style="margin: 0; padding: 0"/>
                <img src="\images\what_we_done\screen_bot.png" class="img-responsive screen-bot"/>

                <div class="top-buffer"></div>
                <img src="\images\what_we_done\screen_top.png" class="img-responsive screen-top" />
                <img src="\images\what_we_done\shah-3.jpg" class="img-responsive" alt="Chat platform for Brav. Develolper" style="margin: 0; padding: 0"/>
                <img src="\images\what_we_done\screen_bot.png" class="img-responsive screen-bot"/>

                <div class="top-buffer"></div>
                <img src="\images\what_we_done\screen_top.png" class="img-responsive screen-top" />
                <img src="\images\what_we_done\shah-4.jpg" class="img-responsive" alt="Chat platform for Brav. Develolper" style="margin: 0; padding: 0"/>
                <img src="\images\what_we_done\screen_bot.png" class="img-responsive screen-bot"/>
